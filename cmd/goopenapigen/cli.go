...
func runManifestSyncCommand(argsArr []string) error {
	...
	flagSet.StringVar(&config.Bump, "bump", "", "version bump: major, minor, patch, premajor, preminor, prepatch, or prerelease")
	flagSet.StringVar(&config.AutoBump, "auto-bump", "", "version bump only when source hash changed: major, minor, patch, premajor, preminor, prepatch, or prerelease")
